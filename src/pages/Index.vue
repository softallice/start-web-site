<template>
  <q-layout view="lHh lpr lFf">
    <q-header class="q-py-sm" style="background-color: white;" :style="'border-bottom: 2px solid '+ theme_color">
        <q-toolbar>
        <span :style="'font-size: 35px;color:'+theme_color" class="my-font text-h6 q-mr-md">Oriental medicine</span>
        <q-space ></q-space>
      <q-tabs v-model="selected_tab" shrink>
        <q-tab :style= "[selected_tab == 't_0' ? {backgroundColor: white} : {}]" class="q-mr-sm q-py-xs custom_tab" @click="scrollToElement('id_portfolio');" style="width:120px;min-height:auto !important;color: black" label="Portfolio" />
        <q-tab :style= "[selected_tab == 't_1' ? {backgroundColor: white} : {}]" class="q-mr-sm q-py-xs custom_tab" @click="scrollToElement('id_about_us');" style="width:120px;min-height:auto !important;color: black" label="About Us" />
        <q-tab :style= "[selected_tab == 't_2' ? {backgroundColor: white} : {}]" class="q-mr-sm q-py-xs custom_tab" @click="scrollToElement('id_services');" style="width:120px;min-height:auto !important;color: black" label="Services" />
        <q-tab :style= "[selected_tab == 't_3' ? {backgroundColor: white} : {}]" class="q-mr-sm q-py-xs custom_tab" @click="scrollToElement('id_testimonial');" style="min-height:auto !important;color: black" label="Testimonial" />
        <q-tab :style= "[selected_tab == 't_4' ? {backgroundColor: white} : {}]" class="q-mr-sm q-py-xs custom_tab" @click="scrollToElement('id_team');" style="width:120px;min-height:auto !important;color: black" label="Team" />
        <q-tab :style= "[selected_tab == 't_5' ? {backgroundColor: white} : {}]" class="q-mr-sm q-py-xs custom_tab" @click="scrollToElement('id_pricing');" style="width:120px;min-height:auto !important;color: black" label="Pricing" />
	<q-tab :style= "[selected_tab == 't_6' ? {backgroundColor: theme_color} : {}]" class="q-mr-sm q-py-xs custom_tab" @click="scrollToElement('id_news');" style="width:120px;min-height:auto !important;color: black" label="News" />
    ...
    <q-page-container>
      <q-page>
        <q-carousel
          ...
          height="639px"
        >
          <q-carousel-slide class="q-pa-none" :name="1" img-src="https://hamsoa.com/upload/mainbanner/20210216_%EB%A9%B4%EC%97%AD%EB%A0%A5%EC%A6%9D%EC%A7%84_PC%EB%A9%94%EC%9D%B8%EB%B0%B0%EB%84%88.jpg">
<div class="full-height full-width flex flex-center" style="background-color: rgba(0, 0, 0, 0.01) !important;">
...
<q-btn size="md" :style="'background:'+ theme_color +'; color: white'" label="READ MORE"/>
          ...
          <q-carousel-slide class="q-pa-none":name="2" img-src="https://hamsoa.com/upload/mainbanner/20210218_14일의기적_PC메인배너.jpg">
<div class="full-height full-width flex flex-center" style="background-color: rgba(0, 0, 0, 0.01) !important;">
            <div class="custom-caption">
...
<q-btn size="md" :style="'background:'+ theme_color +'; color: white'" label="READ MORE"/>
          ...
          <q-carousel-slide class="q-pa-none":name="3" img-src="https://hamsoa.com/upload/mainbanner/20210208_생리통유형_PC메인배너.jpg">
<div class="full-height full-width flex flex-center" style="background-color: rgba(0, 0, 0, 0.01) !important;">
            <div class="custom-caption">
